...
<div class="max-w-7xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Ingreso manual de mercadería al inventario.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Almacén de Destino</label>
                            <select name="idAlmacen" id="idAlmacen" required class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm text-sm">
                        ...
                        <div>
                            ...
                            <textarea name="observaciones" rows="4" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm text-sm" placeholder="Ej: Compra local sin orden, ajuste de inventario, devolución..."></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden min-h-[500px] flex flex-col">
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                        <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider">Productos a Ingresar</h3>
                        <span class="text-xs text-gray-500 bg-white px-2 py-1 rounded border border-gray-200">Stock Físico</span>
                    </div>

                    <div class="p-6 flex-1">
                        <div class="hidden md:grid grid-cols-12 gap-4 mb-2 px-2">
                            <div class="col-span-9 text-xs font-medium text-gray-500 uppercase">Producto</div>
                            <div class="col-span-2 text-xs font-medium text-gray-500 uppercase text-center">Cantidad</div>
...
<script>
    // Leemos el HTML generado por Blade una sola vez
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                <div class="col-span-1 md:col-span-9">
                    ...
                    <div class="relative producto-select-container">
                        <select name="articulos[${index}][idArticuloMarca]" class="producto-select w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm pr-10" required>
                            ${productOptions}
                        </select>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="number" name="articulos[${index}][cantidad]" min="1" value="1" required 
                        class="w-full text-center rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" 
                        placeholder="1">
                </div>

                <div class="col-span-1 flex justify-end md:justify-center">
                    <button type="button" onclick="eliminarProducto(this)" class="text-gray-400 hover:text-red-500 transition p-2 hover:bg-red-50 rounded-full" title="Quitar fila">
