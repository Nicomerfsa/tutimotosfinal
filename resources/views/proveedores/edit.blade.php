...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Editando a: <span class="font-medium text-gray-900">{{ $proveedor->razonSocialProveedor }}</span></p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="razonSocialProveedor" value="{{ old('razonSocialProveedor', $proveedor->razonSocialProveedor) }}" required
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 00-2-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0c0 .884-.956 2.008-2.008 2.008h-.268"></path></svg>
                            </div>
                            <input type="text" name="cuitProveedor" value="{{ old('cuitProveedor', $proveedor->cuitProveedor) }}" maxlength="11" required
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors">
                        </div>
                        @error('cuitProveedor')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="telefonoProveedor" value="{{ old('telefonoProveedor', $proveedor->telefonoProveedor) }}"
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="correoProveedor" value="{{ old('correoProveedor', $proveedor->correoProveedor) }}"
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="direccionProveedor" value="{{ old('direccionProveedor', $proveedor->direccionProveedor) }}"
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="url" name="webProveedor" value="{{ old('webProveedor', $proveedor->webProveedor) }}"
                                class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="observaciones" rows="3"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors">{{ old('observaciones', $proveedor->observaciones) }}</textarea>
                    </div>
