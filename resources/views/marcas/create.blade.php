...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        <h2 class="text-2xl font-bold text-gray-900">Crear Nueva Marca</h2>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="descripcionMarca" rows="4"
                            ...
                            placeholder="Información adicional sobre la marca...">{{ old('descripcionMarca') }}</textarea>
